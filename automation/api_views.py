...
def check_availability_n8n(request, secretKey):
    ...
    """
    try:
        print("\n[DEBUG] check_availability_n8n called with secretKey:", secretKey)
        ...
        try:
            ...
            if parsed_datetime is None:
                ...
                return JsonResponse({
                    "error": "The date was not submitted correctly. Please provide the date in this format: YYYY-MM-DDTHH:MM:SS"
                }, status=400)
            ...
            return JsonResponse({
                "error": f"The date was not submitted correctly. Please provide the date in this format: YYYY-MM-DDTHH:MM:SS"
            }, status=400)
